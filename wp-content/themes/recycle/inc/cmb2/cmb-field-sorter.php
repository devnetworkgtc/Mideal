...
function tb_sorter_enqueue() {	
	wp_enqueue_script( 'tb-sorter-field-init', get_template_directory_uri() . '/inc/cmb2/js/sorter-init.js', array('jquery-ui-sortable'), TB_SORTER_VERSION );	
	wp_enqueue_style( 'tb-sorter-field-mods', get_template_directory_uri() . '/inc/cmb2/css/sorter.css', array(), TB_SORTER_VERSION );
}
